...
class GoogleSearchConsoleQueryPageWeeks78To1Export(BaseGoogleSearchConsoleExport):
    _EXPORT_NAME = "googlesearchconsole_query_page_weeks_78_to_1"
    _MEASUREMENT_UNIT = "weeks"
    _BEGIN = 78  # period begins _BEGIN _MEASUREMENT_UNIT ago
